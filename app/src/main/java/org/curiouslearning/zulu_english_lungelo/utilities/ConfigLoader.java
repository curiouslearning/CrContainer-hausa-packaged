package org.curiouslearning.zulu_english_lungelo.utilities;
...
public class ConfigLoader {
    ...
    public static String getSlackWebhookUrl(Context context) {
        try {
            ...
            // Decrypt webhook
            byte[] decryptedBytes = org.curiouslearning.zulu_english_lungelo.utilities.CryptoUtils.decryptAesCbc(
                    aesKeyBytes,
                    iv,
                    encryptedWebhook
            ).getBytes();
