package org.curiouslearning.zulu_english_lungelo.presentation.adapters;
...
import org.curiouslearning.zulu_english_lungelo.R;
...
import org.curiouslearning.zulu_english_lungelo.utilities.ImageLoader;
import org.curiouslearning.zulu_english_lungelo.utilities.AudioPlayer;
import org.curiouslearning.zulu_english_lungelo.utilities.PulsingView;
        ...
        holder.appIconImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AnimationUtil.scaleButton(v, new Runnable() {
                    @Override
                    public void run() {
                        Intent intent = new Intent(ctx, org.curiouslearning.zulu_english_lungelo.WebApp.class);
