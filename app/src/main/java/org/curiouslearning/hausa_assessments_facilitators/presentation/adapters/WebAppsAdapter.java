...
import org.curiouslearning.hausa_assessments_facilitators.utilities.ImageLoader;
import org.curiouslearning.hausa_assessments_facilitators.utilities.AudioPlayer;
import org.curiouslearning.hausa_assessments_facilitators.utilities.PulsingView;
        ...
        holder.appIconImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AnimationUtil.scaleButton(v, new Runnable() {
                    @Override
                    public void run() {
                        Intent intent = new Intent(ctx, org.curiouslearning.hausa_assessments_facilitators.WebApp.class);
