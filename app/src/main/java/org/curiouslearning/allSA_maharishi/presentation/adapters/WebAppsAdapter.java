package org.curiouslearning.allSA_maharishi.presentation.adapters;
...
import org.curiouslearning.allSA_maharishi.R;
...
import org.curiouslearning.allSA_maharishi.utilities.ImageLoader;
import org.curiouslearning.allSA_maharishi.utilities.AudioPlayer;
import org.curiouslearning.allSA_maharishi.utilities.PulsingView;
        ...
        holder.appIconImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AnimationUtil.scaleButton(v, new Runnable() {
                    @Override
                    public void run() {
                        Intent intent = new Intent(ctx, org.curiouslearning.allSA_maharishi.WebApp.class);
